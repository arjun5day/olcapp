...
<title>Update Computer Student</title>
	...
	<div id="appwrapper">
		...
		<div id="appbody">
				<div id="computer_tabs">
					<ul>
						<li><a href="#tabs-1">Update Computer Student</a></li>
					...
					<div id="tabs-1">
						<div class="appbodyhead"> Update Computer Student
                        ...
                        <?php 
							if(isset($_GET['cedit'])){
								...
								$edit_query = "SELECT * FROM tbl_computers where s_no = '$s_no'";
								$run_edit = mysqli_query ($connection, $edit_query);
								while ($edit_row = mysqli_fetch_array($run_edit)){

									$ufirst_name = $edit_row['first_name'];
									$umiddle_name = $edit_row['middle_name'];
									$ulast_name = $edit_row['last_name'];
									$uaddress = $edit_row['address'];
									$uemail = $edit_row['email'];
									$ugender = $edit_row['gender'];
									$udob = $edit_row['dob'];
									$ucontact_no = $edit_row['contact_no'];
									$ujoined_date = $edit_row['joined_date'];
									$ucourse = $edit_row['course'];
									$utotal_fee = $edit_row['total_fee'];
									$upaid_fee = $edit_row['paid_fee'];
									$udue_payment_date = $edit_row['due_payment_date'];
								}
							
							}
						?>
							<form action="actions/edit_computer_action.php" method="post" enctype="multipart/form-data" onsubmit="return validatecs();">
							<input type="hidden" name="s_no" value="<?php echo $s_no; ?>" />
							  <table width="445" height="330">
								...
								<tr>
								  ...
								  <td><input type="text" name="first_name" id="first_name" value="<?php echo $ufirst_name; ?>" class="input" /></td>
							    </tr>
								<tr>
								  <td scope="row">Middle Name:</td>
								  <td><input name="middle_name" type="text" id="middle_name" value="<?php echo $umiddle_name; ?>" class="input" /></td>
							    </tr>
								<tr>
								  <td scope="row">Last Name:</td>
								  <td><input name="last_name" type="text" id="last_name" value="<?php echo $ulast_name; ?>" class="input" /></td>
								</tr>
								<tr>
								  <td scope="row">Address:</td>
								  <td><input name="address" type="text" id="address" class="input" value="<?php echo $uaddress; ?>" /></td>
								</tr>
								<tr>
								  <td scope="row">Email:</td>
								  <td><input name="email" type="text" id="email" class="input" value="<?php echo $uemail; ?>"/></td>
							    </tr>
								<tr>
								...
								<tr>
								  ...
								  <td><input name="dob" type="text" id="dob" class="input" value="<?php echo $udob; ?>"/></td>
								</tr>
								<tr>
								  <td scope="row">Contact No: </td>
								  <td><input name="contact_no" type="text" value="<?php echo $ucontact_no; ?>" id="contact_no" onkeypress="return isNumber(event)" class="input" maxlength="10" /></td>
								</tr>
								<tr>
								  <td scope="row">Joined Date: </td>
								  <td><input type="text" name="jd" id="jd" class="input" value="<?php echo $ujoined_date; ?>" /></td>
								</tr>
							  </table>
					  ...
					  <div class="rightappbody">
					    <table width="445" height="330">
                          ...
                          <tr>
                            ...
                            <td><input name="amount_to_pay" type="text" id="amount_to_pay" value="<?php echo $utotal_fee ?>" onkeypress="return isNumber(event)" class="input"/></td>
                          </tr>

                          <tr>
                            <td scope="row">Amount paid (Rs.): </td>
                            <td><input name="amount_paid" type="text" id="amount_paid" value="<?php echo $upaid_fee; ?>" onkeypress="return isNumber(event)" class="input"/></td>
                          </tr>
                          <tr>
                            <td scope="row">Due payment Date: </td>
                            <td><p>
                                <input name="due_pay_date" type="text" id="due_pay_date" class="input" value="<?php echo $udue_payment_date ?>" />
                                <br />
                            </p></td>
                          </tr>
                          <tr>
                ...
                <div class="appbodyhead">Computer Student Admision:
                	...
                	<div class="fullappbody">hello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hiihello hii</div><!--fullappbody close-->
				</div><!--tab-4 close-->
